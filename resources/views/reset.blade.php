...
<title>بازیابی رمز عبور - FoodEase</title>
...
<main>
  <div class="md-card md-card-elevated" style="max-width:420px;margin:40px auto;padding:30px;">
    <h2 style="text-align:center;">بازیابی رمز عبور</h2>
    ...
    <form action="login.html">
      ...
      <div style="text-align:center;margin-top:16px;">
        <button class="md-btn md-filled md-md">ذخیره رمز</button>
      </div>

      <p style="text-align:center;">
        <a href="login.html" class="md-btn md-text md-sm">بازگشت به ورود</a>
      </p>
    </form>
  </div>
</main>
